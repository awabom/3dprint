...
Revised = "2023-11-15"  # Revision date for this file.
...
TOOLTIP = """
Generate g-code from a Path that is compatible with EnderCNC (Tested on Ender 3 V2 with mriscoc firmware).
"""
...
def export(objectslist, filename, argstring):
    ...
    for obj in objectslist:
        ...
        if OUTPUT_COMMENTS:
            ...
            gcode += linenumber() + "M117 Op: " + obj.Label + "\n"
...
def parse(pathobj):
    ...
    if hasattr(pathobj, "Group"):  # We have a compound or project.
        ...
        for c in PathUtils.getPathWithPlacement(pathobj).Commands:
            ...
            # Remove embedded comments, or convert to semi-colon comments:
            tmplist = []
            list_index = 0
            while list_index < len(outlist):
                ...
                if left_index == -1:  # Not a comment
                    ...
                    if not OUTPUT_COMMENTS:
                        ...
                        line_minus_comment = (
                            outlist[list_index].replace(comment_area, "\n; " + comment_area + "\n").strip()
                        )
            ...
            # Done removing/converting comments
            outlist = tmplist
...
def drill_translate(outlist, cmd, params):
    ...
    def rapid_Z_to(new_Z):
        ...
        Drill.gcode += format(float(new_Z.getValueAs(UNIT_FORMAT)), strFormat) + " F600\n"
    ...
    Drill.gcode += format(float(drill_Y.getValueAs(UNIT_FORMAT)), strFormat) + " F1200\n"
